...
import { changeSelectedItem, setSelectedWorkspace } from '../../../../../store/actions/dropdownActions';
...
const DropdownItem: FC<IDropdownItem> = ({ icon, name, route, closeDropdown }) => {
	...
	if (route === '/workspaces')
		return (
			<StyledLink to={route} onClick={() => dispatch<SetSelectedWorkspace>(setSelectedWorkspace(name))}>
				<Wrapper
